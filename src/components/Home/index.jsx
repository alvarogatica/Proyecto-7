  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-4 bg-[#fdf9f4]">
      <div className="text-center max-w-2xl">
        <h1 className="text-8xl font-extrabold mb-8 text-gray-900">
          urdupes.cl
        </h1>
        ...
        <section className="flex flex-col gap-8 w-full max-w-md mx-auto">
          <Link
            to="/purses"
            className="btn-product flex items-center justify-center gap-3 px-8 py-5 text-lg transition-transform duration-300 ease-in-out hover:scale-110 hover:shadow-lg"
          >
            <ShoppingBag size={28} />
            Ver carteras
          </Link>
